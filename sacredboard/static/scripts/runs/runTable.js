...
define(["bootstrap", "datatables", "jquery", "runs/detailView"], function (bootstrap, datatables, $, generateDetailView) {
     ...
     * @param tableElement
     * @param optUpdateConfig - a function that processes the jDataTable config and modifies it
     */
    var createRunTable = function (tableElement, optUpdateConfig) {
        ...
        if (typeof(optUpdateConfig) == "function") {
            optUpdateConfig(config);
        }
